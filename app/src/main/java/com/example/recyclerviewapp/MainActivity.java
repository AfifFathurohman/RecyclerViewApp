...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareMahasiswaData() {
        ...
        mahasiswaList.add(new Mahasiswa("Afif Fathurohman","311710477","081310872828"));
        mahasiswaList.add(new Mahasiswa("Widi Anggraeni Puspitasari","311710603","081233944476"));
        mahasiswaList.add(new Mahasiswa("Dimas Panji Adityantoro","311710065","087792876629"));
        mahasiswaList.add(new Mahasiswa("Siti Fazriah","311710433","081387826628"));
    }
